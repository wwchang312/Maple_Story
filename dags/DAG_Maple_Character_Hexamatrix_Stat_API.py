...
with DAG(
    ...
    maple_character_hexamatrix_stat_ETL_task = MapleApiOperator.partial(
        task_id='maple_character_hexamatrix_stat_ETL_task',
        data_nm='character/hexamatrix-stat').expand(
            ocid=ocid,
            date= view_date
            )

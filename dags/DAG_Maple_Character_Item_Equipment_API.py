...
with DAG(
    ...
    maple_character_item_equipment_ETL_task = MapleApiOperator.partial(
        task_id='maple_character_item_equipment_ETL_task',
        data_nm='character/item-equipment').expand(
            ocid=ocid,
            date = view_date
            )
